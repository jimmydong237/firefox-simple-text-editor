...
function handleClick() {
  if ( sp.prefs.editorType === "S" ) simpleEditor()
  if ( sp.prefs.editorType === "A" ) advancedEditor()
}
...
function advancedEditor() {
  tabs.open('data:text/html,<script src="http://ace.c9.io/build/src/ace.js"></script><div id="e" style="height:100%"></div><script>ace.edit("e")</script>')
}
